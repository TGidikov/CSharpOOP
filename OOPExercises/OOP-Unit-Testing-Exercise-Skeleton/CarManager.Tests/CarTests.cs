...
namespace Tests
{
    public class CarTests
    {
        ...
        public void TestMakeValidation()
        {
            ...
            {
                Car newCar = new Car(null, "Z3", 15, 300);
            });
        }
        ...
        public void TestModelValidation()
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Car newCar = new Car("BMW", null, 15, 300);
            });
        }
        ...
        public void TestFuelConsumptionValidation()
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Car newCar = new Car("BMW", "Z3", -3, 300);
            });
        }
        ...
        public void TestFuelCapacityValidation()
        {
            Assert.Throws<ArgumentException>(() =>
            {
                Car newCar = new Car("BMW", "Z4", 15, 0);
            });
        }
